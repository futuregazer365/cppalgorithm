// 二叉搜索树的搜索.cpp : 此文件包含 "main" 函数。程序执行将在此处开始并结束。
// leetcode 700
#include <vector>
#include <stack>
#include <algorithm>
...
int main()
{
    vector<int> v = { 4,2,1,0,0,3,0,0,7,0,8,0,0 };
    TreeNode<int>* root = buildTreeFromPreorder(v);
    Solution<int> S;
    TreeNode<int>* result = S.searchBST(root, 0);
